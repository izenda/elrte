...
function elDialogForm(o) {
    ...
    var defaults = {
        ...
        submit: function (e, d) {
            d.close();
            setTimeout(function () { $('div.el-dialogform').remove(); $('div.el-palette').remove(); }, 0);
        },
            ...
            if (!v && v !== '') {
                ...
                if (v.nodeName || v.css) {
                    ...
                    if ((b = v.css('border'))) {
                        ...
                        if (!w)
                            w = v.css('border-top-width');
                        s = v.css('border-style');
                        if (!s)
                            s = v.css('border-top-style');
                        c = v.css('border-color');
                        if (!c)
                            c = v.css('border-top-color');
                    }
...
(function ($) {
    ...
    $.fn.elSelect = function (o) {
        ...
        function updateLabel(v) {
            ...
            label.html(tpl.replace(/%val/g, v).replace(/%label/g, opts.src[v])).children().attr({ unselectable: 'on' });
        }
...
(function ($) {
    elRTE.prototype.options = {
        ...
        toolbars: {
            ...
            maxi: [/*'save',*/ 'copypaste', 'undoredo', 'elfinder', 'style', 'alignment', 'direction', 'colors', 'format', 'indent', 'lists', 'links', 'elements', 'media', 'tables', 'mypanel' /*, 'fullscreen'*/],
...
(function ($) {
    elRTE.prototype.ui = function (rte) {
        ...
        while (tbl--) {
            ...
            if (this.rte.options.panels[pname]) {
...
(function ($) {
    elRTE.prototype.ui.prototype.buttons.image = function (rte, name) {
        ...
        this.command = function () {
            ...
            dialog.tab('main', this.rte.i18n('Properties'))
...
(function ($) {
    elRTE.prototype.ui.prototype.buttons.link = function (rte, name) {
        ...
        this.command = function () {
            ...
            d.tab('main', this.rte.i18n('Properties'))
